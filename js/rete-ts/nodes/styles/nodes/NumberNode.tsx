...
>`
  ...
  .control {
    display: block;
    padding: ${$socketmargin}px ${$socketsize / 2 + $socketmargin * 2}px
      ${$socketmargin}px ${$socketsize / 2 + $socketmargin}px;
  }
  .sockets {
...
export function NumberNode<Scheme extends ClassicScheme>(props: Props<Scheme>) {
