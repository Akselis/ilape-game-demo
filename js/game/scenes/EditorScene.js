...
export class EditorScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Remove Tool Button DOM Setup (Handled by React)
        /* 
        const buttons = {
        ...
        Object.entries(buttons).forEach(([buttonId, toolName]) => {
            ...
            if (button) { // Add check in case button is missing
        ...
        */
        ...
        // Remove Preview Button DOM Setup (Handled by React)
        /* 
        const previewButton = document.getElementById('preview-button');
        if (previewButton) { // Add check
            previewButton.addEventListener('click', () => this.togglePreview());
        } else {
            console.warn(`Button with ID 'preview-button' not found.`);
        }
        */
        
        // Remove default tool selection (Handled by React)
    ...
    togglePreview() {
        ...
        if (this.isPreviewMode) {
            ...
            if (this.player) {
                ...
                this.triggers.getChildren().forEach(trigger => {
                    // Enable physics for trigger if not already enabled
                    if (!trigger.body) {
